 ...
 */
//	$.ajax({
//		url:ajaxUrl+"/banner/list/location?userId="+userID+"&location=5",
//		type:"get",
//		async:true,
//		success:function(res){	
//			var imgUrl = res.data[0].imgUrl.split(",")[0];
...
//		window.location.href = "./instrRebate.html?userId="+userID;
//	});
/**
 * 获取用户信息 是否绑定手机
 */
...
$('.content').dropload({   	
    ...
    loadDownFn : function(me){
        ...
        $.ajax({
            type: "GET",
            url: ajaxUrl+"/investment/task/list?pageNo="+page+"&userId="+userID,
            dataType: 'json',
                		...
                		<div class="taskItem borderT1" onclick="getRebate(${isTelephone+","+userID+","+result[i].id})">
							<div class="l">
								...
								<div class="info">
									...
									<p class="taskInstr">${result[i].taskPresent==null?"":result[i].taskPresent}<span class="red">额外+${result[i].rebateGold}金币</span></p>
								</div>
							</div>
							<div class="r">
